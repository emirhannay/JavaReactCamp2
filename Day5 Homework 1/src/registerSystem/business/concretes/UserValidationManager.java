...
public class UserValidationManager implements UserValidationService {
	...
	public boolean validate(User user) {
		...
		return isEmailFormatValid(user.get_eMail()) && isPasswordLengthValid(user.getPassword()) && isFirstNameLengthValid(user.getFirstName()) && isLastNameLengthValid(user.getLastName()) &&
				isAllFieldsFilled(user.getFirstName(), user.getLastName(), user.get_eMail(), user.getPassword());
